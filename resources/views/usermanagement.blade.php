...
<x-app-layout>
    ...
    <div class="py-12">
		...
		<div class="text-right">
			...
			<a class="m-5" title="New Person" href="/admin/user-form/new"><span class="fas fa-plus"></span></a>
			@endif
			...
			<td>
				...
				@if(Auth::user()->hasRole('admin'))
				<a href="/admin/user-form/{{ $u->id }}" title="Edit"><span class="fas fa-pencil-alt"></span></a>
